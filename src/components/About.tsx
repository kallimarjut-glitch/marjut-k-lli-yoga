        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              When I was 19, I moved abroad and spent years searching for a deeper sense of fulfilment in life. Along the way, I learned that feeling aligned isn't about becoming someone else or chasing things from the outside; it's about reconnecting with who you already are.
            </p>
