    ...
    <section id="gallery" className="py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <figure className="max-w-3xl mx-auto text-center relative">
          ...
          <blockquote className="font-serif italic text-2xl md:text-3xl text-foreground leading-relaxed pt-6">
            Alignment isn't about a perfect pose — it's about coming home to yourself,
            again and again.
          </blockquote>
        </figure>
      </div>
